...
const ContentUploadOptionsDrawer: React.FC<IContentUploadOptionsProps> = ({
    ...
    <>
      <div>
        {/* <div className="flex  justify-between border-b border-secondary align-middle text-start px-3 pt-4 pb-2">
          <div className={`  text-base pb-2 ${fontItalic.className}`}>
            <div>
...
export default ContentUploadOptionsDrawer;

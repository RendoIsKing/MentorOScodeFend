...
const NotificationRow: React.FC<NotificationProps> = ({ actorAvatar, actorName, verb, text, mediaThumb }) => {
  ...
  return (
    <div className="flex items-start justify-between gap-3 py-3 bg-[hsl(var(--card))] border border-[hsl(var(--border))] rounded-[var(--radius)] px-3 transition-colors hover:bg-[hsl(var(--accent))] hover:border-[hsl(var(--border))]">

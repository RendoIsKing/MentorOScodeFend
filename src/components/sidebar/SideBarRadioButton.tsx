...
//   const [hasDocumentVerified, setHasDocumentVerified] = useState(false);
...
//           parsedAuth.subscriptiondetails?.status === "active";
//         setHasDocumentVerified(isSubscriptionActive);
//       } catch (error) {
...
//       icon: <Search />,
//       segment: "(search)",
//       hasDocumentVerified: !hasDocumentVerified,
//     },
//     {
//       id: 3,
//       name: "Inbox",
